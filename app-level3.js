// Security with env vars, will create file called .env in the root directory.
// To use env var, will add this line of code in the top of the page
...
// Grab the secret key from the .env file we created for this level of security
